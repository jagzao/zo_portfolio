      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-16 text-center reveal">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Más de 4 años desarrollando soluciones tecnológicas innovadoras, 
            ...
            >
              <Card className="relative group hover:border-primary/50 transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  {/* Achievements */}
                  <div className="mb-6">
                    <h5 className="font-semibold mb-3 text-foreground">Logros Destacados:</h5>
                  ...
                  {/* Technologies */}
                  <div className="mb-4">
                    <h5 className="font-semibold mb-3 text-foreground">Tecnologías:</h5>
                  ...
                  {exp.projects && exp.projects.length > 0 && (
                    <div className="pt-4 border-t border-border/30">
                      <h5 className="font-semibold mb-2 text-foreground">Proyectos Relacionados:</h5>
                      <div className="flex flex-wrap gap-2">
